...
# whereby text like :) was a happy face and text
# like :( was a sad face. Nowadays, programs tend
# to convert emoticons to emoji automatically!

# In a file called faces.py, implement a function
# called convert that accepts a str as input and
# returns that same input with any :) converted to 🙂
# (otherwise known as a slightly smiling face) and
