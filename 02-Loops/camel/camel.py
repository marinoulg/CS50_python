...
# whereby the first letter of the first word is lowercase but the first letter
# of each subsequent word is uppercase. For instance, whereas a variable for a
# user’s name might be called name, a variable for a user’s first name might be
# called firstName, and a variable for a user’s preferred first name
